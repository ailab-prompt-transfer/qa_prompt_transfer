...
"""
    Closed-book QA => When only question
    
    Open-book QA => When with context and question
"""


class squadclosedPromptT5Formatter(BasicFormatter):
