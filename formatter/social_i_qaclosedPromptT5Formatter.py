...
class social_i_qaclosedPromptT5Formatter(BasicFormatter):
    ...
    def process(self, data, config, mode, *args, **params):
        ...
        for ins in data:
            ...
            text = ["question:", ins["question"], "choice:", choice_token, ins["answerA"], choice_token, ins["answerB"], choice_token, ins["answerC"]]
