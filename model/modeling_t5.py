...
# add_start_docstrings_to_model_forward,# latest에 추가됨
...
class T5Block(nn.Module):
    ...
    def forward(
        ...
        return (
            outputs  # hidden-states, present_key_value_states, (self-attention position bias), (self-attention weights), (cross-attention position bias), (cross-attention weights)
        )
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def prepare_inputs_for_generation(
        self, input_ids, past=None, attention_mask=None, head_mask=None, decoder_head_mask=None, cross_attn_head_mask=None, use_cache=None, encoder_outputs=None, **kwargs
    ):
